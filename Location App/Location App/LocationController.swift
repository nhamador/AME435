...
class LocationController: NSObject, ObservableObject, CLLocationManagerDelegate
{
    ...
    @Published var region: MKCoordinateRegion = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 33.4242, longitude: -111.9281), span: MKCoordinateSpan(latitudeDelta: 0.01, longitudeDelta: 0.01)) //should be something else at start 
